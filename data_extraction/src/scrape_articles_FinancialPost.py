...
def separate_into_indicator_baskets(output_folder):
    ...
    mortgage_entries = allocate_to_indicator_basket(entries,'mortgagerates',mortgage_keywords,output_folder)
    interestrate_entries = allocate_to_indicator_basket(entries,'interestrates',interestrate_keywords,output_folder)
