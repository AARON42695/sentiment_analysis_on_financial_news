...
def bnn_article_scraper(query, out_path):
    ...
    with open(out_path + '_'.join(query.split()) + '_' + str(len(output_list)) + '_Bloomberg_article.json',
              'w') as json_file:
