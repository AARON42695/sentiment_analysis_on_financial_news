...
def sample_dataframe_by_month(dataframe, sample_size, keyword):
    ...
    if sample_size == 0:
        sample_df = pd.DataFrame(columns=dataframe.columns)
...
bloomberg_interestrates_comb = combine_fp_bloomberg(unanno_file_path + 'interest_rates_100_Bloomberg_article.json', unanno_file_path + 'interest_rates_fpbloomberg.json')
sample_bloomberg_interestrates = sample_dataframe_by_month(bloomberg_interestrates_comb, 3, 'interestrates_bloomberg')
assert os.path.exists(annotated_output_path + 'interestrates_bloomberg_sampled.csv')
...
sample_bloomberg_housing = sample_dataframe_by_month(bloomberg_housing_comb, 3, 'housing_bloomberg')
assert os.path.exists(annotated_output_path + 'housing_bloomberg_sampled.csv')
...
sample_bloomberg_gdp = sample_dataframe_by_month(bloomberg_gdp_comb, 3, 'gdp_bloomberg')
assert os.path.exists(annotated_output_path + 'gdp_bloomberg_sampled.csv')
...
sample_bloomberg_employment = sample_dataframe_by_month(bloomberg_employment_comb, 3, 'employment_bloomberg')
assert os.path.exists(annotated_output_path + 'employment_bloomberg_sampled.csv')
...
sample_bloomberg_tsx = sample_dataframe_by_month(bloomberg_tsx_comb, 3, 'tsx_bloomberg')
assert os.path.exists(annotated_output_path + 'tsx_bloomberg_sampled.csv')
...
bloomberg_mortgagerates_comb = combine_fp_bloomberg(unanno_file_path + 'mortgage_rates_100_Bloomberg_article.json', unanno_file_path + 'mortgage_rates_fpbloomberg.json')
sample_bloomberg_mortgagerates = sample_dataframe_by_month(bloomberg_mortgagerates_comb, 3, 'mortgagerates_bloomberg')
assert os.path.exists(annotated_output_path + 'mortgagerates_bloomberg_sampled.csv')
